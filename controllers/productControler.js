...
const { fileSizeFormatter, uploadFromBuffer } = require('../utils/fileUpload')
...
const createProduct = asyncHandler(async (req, res) => {
  ...
  if (req.file) {
    ...
    const uploadedFile = await uploadFromBuffer(req.file.buffer)
    // try {
    //   uploadedFile = await cloudinary.uploader.uploadFromBuffer(req.file.path, {
    //     folder: 'Pinvent App',
    //     resource_type: 'image',
    //   })
    // } catch (error) {
